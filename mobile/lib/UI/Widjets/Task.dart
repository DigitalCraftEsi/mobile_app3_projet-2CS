...
class Task extends StatelessWidget {
  Task({Key? key, required this.title, required this.startDate, required this.endDate, required this.percentage}) : super(key: key);
  final String title;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => TaskDetailsScreen(title: title, startDate: startDate, endDate: endDate, percentage: percentage,)),
      );
    },
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.calendar_today_outlined,size: 19,color: percentage >= 80 ? Colors.red : Color.fromRGBO(1, 113, 75, 1),),
                    SizedBox(width: 5,),
                    Text("$endDate",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 14,color:  percentage >= 80 ? Colors.red : Color.fromRGBO(1, 113, 75, 1),),),
                  ],
                ),
            ...
            Row(
              ...
              children: [
                ...
                Slider(
                  ...
                  max: 100,
                  divisions: 100,
                  activeColor: percentage >= 80 ? Colors.red : Color.fromRGBO(1, 113, 75, 1),
