...
class TaskDetailsScreen extends StatelessWidget {
  const TaskDetailsScreen({Key? key, required this.title, required this.startDate, required this.endDate, required this.percentage}) : super(key: key);
  final String title;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      Container(
                        ...
                        child: Text(title,style: TextStyle(fontWeight: FontWeight.w700,color:Color.fromRGBO(14, 14, 14, 1),fontSize: 20),),
                      ),
                        SizedBox(height: 15,),
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                                ...
                                children:[
                                  ...
                                  Text("$startDate",style: TextStyle(fontWeight: FontWeight.w600,color: Color.fromRGBO(14, 14, 14, 1),fontSize: 12),),
                                  Text("$endDate",style: TextStyle(fontWeight: FontWeight.w600,color: Color.fromRGBO(1, 113, 75, 1),fontSize: 12),),
                                  Text("2023-06-20",style: TextStyle(fontWeight: FontWeight.w600,color: Color.fromRGBO(14, 14, 14, 1),fontSize: 12),),
